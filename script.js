...
document.getElementById('visualize-nodes').addEventListener('click', function() {
    ...
    const edgeDataPath = selectedDataset === 'WT_BS' ? 'WT_BS_Edge_processed_with_interaction_Top10.json' : 'Other_Dataset_Edge.json';
            ...
            if (selectedDataset === 'WT_BS') {
                ...
                const fetchData = async () => {
                    try {
                        ...
                        await setupParallelPlotData('WT_BS_Edge_processed_with_interaction_Top10.json'); // Parallel plot specific data
                    } catch (error) {
